...
<body class="brdr-black">
  ...
  <source media="(min-width: 48em)"
        ...
        <img src="images/portfolio/left-baggage/left-luggage-home.jpg" alt="The Rumble Website on Macbook Pro, Ipad and Iphone">
    </picture>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-5 col-md-offset-1">
                <img src="images/portfolio/left-baggage/left-luggage-home.jpg">
            </div>
            <!-- /.col-sm-6 -->
        </div>
        <!-- /.row -->
